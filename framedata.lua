...
local animations = {
    ...
    ATTACK_SETUP_DOWN_1 = {69, 70},
    ATTACK_DOWN_LOOP_1 = {71, 72, "loop"},
    ATTACK_CHARGE_DOWN_2 = {61, 62, "loop"},
    ATTACK_SETUP_DOWN_2= {75, 76},
    ATTACK_DOWN_LOOP_2 = {77, 78, "loop"},
    ATTACK_DOWN_GROUND = {79, 84},
    EXPRESSION_SETUP = {85, 97},
    EXPRESSION = {98, 101, "loop"},
    EXPRESSION_ACCOMODATION = {102, 105},
    TAUNT_SETUP = {106, 113},
    TAUNT = {114, 120, "backnforth"},
    HIT = {121, 121},
    LAUNCHED = {122, 122},
    BLOCK = {123, 124}
}
